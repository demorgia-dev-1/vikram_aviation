                    ...
                    <Link className="flex" to="/">
                        <div className="flex items-start text-lg md:text-xl py-2 font-bold">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-xs sm:text-sm text-start mt-1 font-semibold">A DGCA approved & NABL accredited</p>
                            </div>
                        </div>
                    </Link>
                </motion.div>
                                                ...
                                                <div className="relative" ref={dropdownRef}>
                                                    ...
                                                    {dropdownOpen && (
                                                        ...
                                                        >
                                                            <li>
                                                                <a
                                                                    href="/Vikram Approval Complete.pdf"
                                                                    target="_blank"
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="/Vikram NABL Approval & Capability.pdf"
                                                                    target="_blank"
                                                                    rel="noopener noreferrer"
                                                                    className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                                                                >
